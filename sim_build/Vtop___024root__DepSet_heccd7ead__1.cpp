...
#endif
            VL_FATAL_MT("build/gpu.v", 781, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("build/gpu.v", 781, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("build/gpu.v", 781, "", "Active region did not converge.");
            }
